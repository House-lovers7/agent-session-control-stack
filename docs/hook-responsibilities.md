...
| 面 | session-health v0.3.1 | compact-plus v1.0.4 | pxpipe-proxy v0.8.0 |
|---|---|---|---|
...
| **SessionStart** | 登録なし | 後続のstate lifecycleで使うsession identifierをexport | — |
...
上流のversion・SHA・確認日は [upstreams.lock.json](../config/upstreams.lock.json)、更新時のHuman Approval Gateは [upstream-compatibility.md](upstream-compatibility.md) を原本とする。
