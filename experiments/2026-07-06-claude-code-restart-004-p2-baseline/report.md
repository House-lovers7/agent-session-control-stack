# Experiment 004 Preregistration - 004-p2-baseline
...
- Pair: `2`
- Order: `4`
- Task: `T-B: CREATE TABLE AS modeling + Splinter 0004 no_primary_key`
- ASCS base: `ae3f4b6`
...
- Slice 1: a CTAS table without RLS enabled is flagged by RLS-enablement rules.
- Slice 1: column-level rules neither fire nor crash on a CTAS table with unknown columns.
- Slice 1: libpg and regex backends agree.
- Slice 2: no_primary_key tests use ordinary CREATE TABLE statements without a primary key.
- Slice 2: checkpoint tests do not exercise a CTAS-created table.
- Slice 2: whether no_primary_key should fire for a CTAS-created table remains a post-restart design decision.
...
- Misses the open Slice 2 decision about CTAS-created tables and no_primary_key.
- Reverses Slice 1 CTAS decisions about unknown columns and column-level rule skipping without new evidence.
